...
class Users {
    ...
    public function register($user) {
        $this->db->query("insert into user_profile(firstname, lastname, email, passwordhash, dateofbirth) 
                                                values(:firstname, :lastname, :email, :passwordhash, :dateofbirth)");
        ...
        $this->db->bind(":dateofbirth", $user["dateofbirth"]);
