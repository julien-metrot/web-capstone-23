...
<script src="<?php echo URLROOT; ?>/js/counter.js"></script>
<!-- maps -->
<script src="<?php echo URLROOT; ?>/js/map.js"></script>
<!-- GreenSock -->
<script src="<?php echo URLROOT; ?>/vendor2/layerslider/js/greensock.js"></script>
<!-- LayerSlider script files -->
<script src="<?php echo URLROOT; ?>/vendor2/layerslider/js/layerslider.transitions.js"></script>
<script src="<?php echo URLROOT; ?>/vendor2/layerslider/js/layerslider.kreaturamedia.jquery.js"></script>
<script src="<?php echo URLROOT; ?>/vendor2/layerslider/js/layerslider.load.js"></script>
</body>
</html>