        ...
        <div class="card card-body bg-light">
            ...
            <form action="<?php echo URLROOT; ?>/events/add" method="POST">
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="post_title" id="post_title" class="form-control form-control-lg <?php echo (!empty($data["event_title_error"])) ? "is-invalid" : ""; ?>" value="<?php echo $data["event_title"]; ?>">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="event_date" id="event_description" class="form-control form-control-lg <?php echo (!empty($data["event_description_error"])) ? "is-invalid" : ""; ?>"><?php echo $data["event_description"]; ?></textarea>
                    <span class="invalid-feedback"><?php echo $data["event_description_error"]; ?></span>
                </div>

                <div class="form-group mb-3">
                    <label for="event_description">Event Address: <sup>*</sup></label>
                    <textarea name="event_description" id="event_description" class="form-control form-control-lg <?php echo (!empty($data["event_description_error"])) ? "is-invalid" : ""; ?>"><?php echo $data["event_description"]; ?></textarea>
                    <span class="invalid-feedback"><?php echo $data["event_description_error"]; ?></span>
                </div>
