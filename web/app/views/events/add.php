        ...
        <div class="card card-body bg-light">
            ...
            <form action="<?php echo URLROOT; ?>/events/add" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="event_date" id="event_date" class="form-control form-control-lg <?php echo (!empty($data["event_date_error"])) ? "is-invalid" : ""; ?>"><?php echo $data["event_date"]; ?></input>
